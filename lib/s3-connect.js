module.exports = function(connect) {
    ...
    S3Store.prototype.set = function(sid, sess, fn) {
        ...
        this.db.get(sid, function (err, old, headers) {
            ...
            if (err) {
                ...
                if (delta > this.setThrottle || !_sessEqual(sess, old)) {
                    this.db.put(sid, sess, fn);
                } else {
                    return fn();
                }
    ...
    function _uri_encode(id) {
        ...
        // Avoids use of the following characters which cause folder-like
        // behavior in S3: '/ '.
        // @TODO: What other character should be avoided in session id's in S3?
